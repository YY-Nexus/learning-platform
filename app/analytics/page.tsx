    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-blue-50 to-cyan-50 pb-20">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex items-center space-x-2 mb-6">
          ...
          <Button variant={timeRange === "7d" ? "solid" : "outline"} size="sm" onClick={() => setTimeRange("7d")}>
            7天
          </Button>
          <Button variant={timeRange === "30d" ? "solid" : "outline"} size="sm" onClick={() => setTimeRange("30d")}>
            30天
          </Button>
          <Button variant={timeRange === "90d" ? "solid" : "outline"} size="sm" onClick={() => setTimeRange("90d")}>
            90天
          </Button>
          <Button variant={timeRange === "all" ? "solid" : "outline"} size="sm" onClick={() => setTimeRange("all")}>
            全部
          </Button>
        </div>
              ...
              <svg viewBox="0 0 600 300" className="w-full h-full">
                ...
                {[0, 1, 2, 3, 4, 5].map((hour) => (
                  <g key={hour}>
                    ...
                    <text x="40" y={250 - hour * 40 + 4} fontSize="10" fill="#9ca3af" textAnchor="end">
                      {hour}h
                    </text>
                  </g>
                ))}
            ...
            <div className="flex items-center justify-center">
              <svg viewBox="0 0 240 240" className="w-full h-64">
                ...
                {skillDistributionData.map((skill, index) => {
                  const startAngle =
                    index === 0 ? 0 : skillDistributionData.slice(0, index).reduce((sum, s) => sum + s.value, 0) * 3.6
                ...
                {/* 技能圆环中心文字 */}
                <text x="120" y="110" fontSize="18" fontWeight="bold" textAnchor="middle" fill="#334155">
                  技能水平
                </text>
                <text x="120" y="135" fontSize="24" fontWeight="bold" textAnchor="middle" fill="#1e40af">
                  中级
                </text>
              </svg>
            </div>
